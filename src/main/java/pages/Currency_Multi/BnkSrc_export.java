...
public class BnkSrc_export extends BasePage
{
	  public static String krno1;
	public static String Nub;
	public BnkSrc_export (WebDriver driver)
	{
		super(driver);
	}
	...
	private By ExporttoExcel_ClickElem = By.xpath("//*[@id='ctl00_cPHFilter_btnExportToExcel']");
	private By Downloadpdf_ClickElem = By.xpath("//*[@id='ctl00_cPHFilter_lkbtnExportToPdf']");
	private By Upload_ClickElem = By.xpath("//*[@id='ctl00_cPHFilter_btnUpload']");
...
// 		
     ...
     */
	public void Click_Search_Update__Click()
	{
...
jsExec.executeScript("arguments[0].click()",elem);
	...
	public void ExporttoExcel_Click()
 	{
 	
		WebElement elem = getWebElement(ExporttoExcel_ClickElem);

 		if (elem == null) {
    		ExtentReportManager.failStepWithScreenshot(m_Driver, "Enter_Search_Enter_Searchno", "Enter_Search_Enter_Searchno failed. Unable to locate object: " + ExporttoExcel_ClickElem.toString());

    		TestModellerLogger.FailStepWithScreenshot(m_Driver, "Enter_Search_Enter_Searchno", "Enter_Search_Enter_Searchno failed. Unable to locate object: " + ExporttoExcel_ClickElem.toString());

 			Assert.fail("Unable to locate object: " + ExporttoExcel_ClickElem.toString());
         }
...
// 		
	...
	public void Downloadpdf_ClickElem()
 	{
 	
		WebElement elem = getWebElement(Downloadpdf_ClickElem );
