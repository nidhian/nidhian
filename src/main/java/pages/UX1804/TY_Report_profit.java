...
public class TY_Report_profit extends BasePage
{
	public TY_Report_profit (WebDriver driver)
	{
		super(driver);
	}
...
//	}
	...
	public void Click_PR_Update_CLICK() throws InterruptedException
	{
		...
		WebElement rpt=m_Driver.findElement(By.xpath("//*[@id=\"profitlossdata\"]/tbody/tr[31]/td[3]"));
		String Dssamt2=rpt.getText();
	String Dssamt=Dssamt2.replace("[£]","");
     	System.out.println("Turnover amt" +Dssamt);
     	     	     	
     	addashboard_Report bnn=new addashboard_Report(m_Driver);
     	String rptver1=bnn.rt();
     	
    	//String lk=rptver1.replaceAll("[£]","");
     	System.out.println("received no from bank ds :" +rptver1);
     	
     	SoftAssert stt=new SoftAssert();
     	stt.assertEquals(Dssamt, rptver1);
     	stt.assertAll();
