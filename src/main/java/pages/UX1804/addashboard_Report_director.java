...
public class addashboard_Report_director extends BasePage
{
	public static String rrpt5;
	public addashboard_Report_director (WebDriver driver)
	{
		super(driver);
	}
...
//	private By BankingdashElem = By.xpath("//H3[contains(text(),'Banking')]");
	...
	private By Reports_dashElem = By.xpath("//*[@id='ctl00_divSubContent']/div[9]/div[3]/div[2]");
...
//       // }
     ...
     */
    public void Select_reports_dash(String reports_dash) throws InterruptedException, IOException
 	{
...
//         }
 		...
 		elem.sendKeys(Keys.ENTER);
			Thread.sleep(3000);
 	  String rrpt0=m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_RptDirectorND_ctl00_lnkbalance']")).getText();
 	 rrpt5=rrpt0.replace("[£]","");
 	  GetScreenShot.captureAsImage(m_Driver, rrpt5);
 	  //rrpt5=rpt5.replaceAll("[^0-9]","");
 	    System.out.println("dashboard Director amount shown :" +rrpt5);
// 	   m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_areportlink']/h1/strong")).click();
...
// 		TestModellerLogger.PassStep(m_Driver, "Select_reports_dash " + reports_dash);
 	 //  m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_RptDirectorND_ctl00_lnkbalance']")).click();
 	}
    public  String rt()
    {
    	return rrpt5;
