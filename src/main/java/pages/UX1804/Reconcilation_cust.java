...
public class Reconcilation_cust extends BasePage
{
	public Reconcilation_cust (WebDriver driver)
	{
		super(driver);
	}
...
//
     ...
     */
    public void Select_Account1(String Account1) throws InterruptedException, IOException
 	{
 		...
 		GetScreenShot.captureAsImage(m_Driver, "unreconcilledsale");
