...
public class addashboard_Report extends BasePage
{
	public static String rrpt2;
	public addashboard_Report (WebDriver driver)
	{
		super(driver);
	}
    ...
    public void Select_reports_dash(String reports_dash) throws InterruptedException, IOException
 	{
 		...
 		//elem.sendKeys(Keys.ENTER);
			Thread.sleep(3000);
WebElement wbs=m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_areportlink']/h1/strong"));
 	 String rpt1=wbs.getText();
 	  rrpt2=rpt1.replaceAll("[£]","");
 	  
 	    System.out.println("dashboard amount :" +rrpt2);
 	   GetScreenShot.captureAsImage(m_Driver, rpt1);
