...
public class bank_DB extends BasePage
{ 
	
	
public static String bnkd2;
	public bank_DB (WebDriver driver)
	{
		super(driver);
	}
...
//		Assert.fail("Unable to locate object: " + bnk_selection_dashElem.toString());
 			...
 			String bnkd3=bnkd.getText();
 			
 			bnkd2=bnkd3.replace("[£]","");
 			//GetScreenShot.captureAsImage(m_Driver, bnk_selection_dash);
		System.out.println("amt in bnkdasboard after bank selection bnkd2 :"    +bnkd2);
