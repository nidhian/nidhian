...
m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl"+j+"_cbSelect']")).click();Thread.sleep(1000);break;*/
      Thread.sleep(1000);
      System.out.println("i invove valuejjjj "+i);
            	if(j>9)
            	{
            		            	
           		WebElement eli=m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl"+j+"_cbSelect']"));
   				 jsExec.executeScript("arguments[0].scrollIntoView();", eli);
 				...
 				WebElement ele1= m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl"+i+"_cbSelect']"));
 				 String link2 = ele1.getText();
 				 System.out.println("link   " + link2);
 				 m_Driver.findElement(By.xpath("//*[contains(text(), '"+link2+"')]")).click();
 				 break;
               }
        		else
    			{ 
    		 ...
    		 WebElement ele1= m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_rptrReconcile_ctl00_rptrDebitCredit_ctl0"+i+"_cbSelect']"));
    		 String link2 = ele1.getText();
    			 System.out.println("link   "+ link2);
    		 m_Driver.findElement(By.xpath("//*[contains(text(), '"+link2+"')]")).click();
    		 break;
  	  ...
  	  //ctl00_cPH_rptrReconcile_ctl00_lnkReconcile
