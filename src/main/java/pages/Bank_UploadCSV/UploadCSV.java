...
public class UploadCSV extends BasePage
{
	

	public UploadCSV (WebDriver driver)
	{
		super(driver);
	}
...
private By Money_csv_outElem=By.xpath("//*[@id='ctl00_cPH_gvCSVColumn_ctl05_ddlMappedCol']");
   ...
   public void AssertUrl()
    ...
    public void Select_Select_Bank4(String Select_Bank4)
 	{
       ...
       elem.sendKeys(Keys.ENTER);
 		...
 		utilities.PassScreenshot.Getscreenshot11("Select bank","UploadCSV");
	...
	public void Click_Upload_btn_CSV5() throws InterruptedException
	{
		...
		utilities.PassScreenshot.Getscreenshot11("upload button clicked","UploadCSV");
    ...
    public void Select_Dt_CSV_Colum_map7(String Dt_CSV_Colum_map7)
 	{
 		...
 		utilities.PassScreenshot.Getscreenshot11("Mapping Column ","UploadCSV");
    ...
    public void Select_Des_CSV_Colum_map8(String Des_CSV_Colum_map8)
 	{
 		...
 		utilities.PassScreenshot.Getscreenshot11("Enter Desc","UploadCSV");
    ...
    public void Select_Amt_CSV_Colum_map9(String Amt_CSV_Colum_map9)
 	{
 		...
 		utilities.PassScreenshot.Getscreenshot11("amnt","UploadCSV");
    ...
    public void Select_Moneyout_CSV_Colum(String Money_csv_out)
 	{
 		...
 		utilities.PassScreenshot.Getscreenshot11("Select moneyut","UploadCSV");
	...
	public void Click_Submit_Map_btn_CSV10() throws InterruptedException, IOException
	{
		...
		utilities.PassScreenshot.Getscreenshot11("Click on map btn","UploadCSV");
		  	//String fail=m_Driver.findElement(By.xpath("//*[@id='ctl00_divSubContent']/div[2]/div")).getText();
   /*	List<WebElement> pass=m_Driver.findElements(By.xpath("//*[@id='ctl00_divSubContent']/div[4]/div[4]/div/div"));
    	...
    	if(pass.size()!=0)
    	{
    		...
    		System.out.println("uploaded data correct" +pass.get(0).getText());
    		
    	}
    		else
    	{
    		Assert.assertTrue(pass.size()>0, "incorrect file");
    	}
    		String wt=m_Driver.findElement(By.xpath("//*[@id='ctl00_divSubContent']/div[4]/div[4]/div")).getText();
   		 System.out.println("after check box clicked  "  +wt);
    	}*/
		List<WebElement> pass=m_Driver.findElements(By.xpath("//*[@id='ctl00_divSubContent']/div[4]/div[4]/div/div"));
		int count=pass.size();
	   ...
	   WebElement chkbox= m_Driver.findElement(By.xpath("//*[@id='ctl00_cPH_chkcol']"));
				...
				utilities.PassScreenshot.Getscreenshot11("Messages after upload","UploadCSV");
			}
