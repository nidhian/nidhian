...
public class Ledgerbook_Soltrad extends BasePage
{
    static List<String> Newlist=new ArrayList<String>();
    
	   
    static int totalcount=0;
	public Ledgerbook_Soltrad (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
     ...
     */
	public void Click_AdvisorTool_Toplft2()
	{
     ...
     */
	public void Click_Reports_menu_inadvisorytool2() throws InterruptedException
	{
...
//		TestModellerLogger.PassStep(m_Driver, "Click_Reports_menu_inadvisorytool");
     ...
     */
	public void Click_GnralLdgerNominal_Ldgr_Rprtclicked2() throws InterruptedException
	{
    ...
    */
   public void Select_selectAccountType2()
    {
...
//        int i=0;
    ...
    * 
    */
   public void matchFromExcel2() throws EncryptedDocumentException, InvalidFormatException, IOException
   {
