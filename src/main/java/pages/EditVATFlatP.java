...
public class EditVATFlatP extends BasePage
{
	...
	private By UseDefaultRateElem = By.xpath("//*[@id='ctl00_cPH_chkUseDefaultRate']");
...
//	private By OverrideFLATRateElem = By.id("ctl00_cPH_chkUseDefaultRate");
   ...
   public void AssertUrl()
	...
	//	elem.click();
		...
		ExtentReportManager.passStep(m_Driver, "Click_SaveButton");		TestModellerLogger.PassStep(m_Driver, "Click_SaveButton");
	}
}