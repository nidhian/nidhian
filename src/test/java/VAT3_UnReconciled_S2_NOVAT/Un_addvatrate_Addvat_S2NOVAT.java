...
public class Un_addvatrate_Addvat_S2NOVAT extends TestBase
{
...
//  _EditSettingToStandard.Click_VATTypeEdit();
        ...
        pages.VAT3.addVatrate _addVatrate = new  pages.VAT3.addVatrate(driver);
