package test2.Nidhi.advance_reconsile;
...
public class SupplierBill_advancerec_withbank extends TestBase
{
...
//     _SupplierBillSToFRS.Enter_Date(data[7]);
     ...
     TestModellerLogger.SetLastNodeGuid("7ea52093-1dd7-4979-8034-aeaef336d945");
     _SupplierBillSToFRS.Expenset(data[7]);
     ...
     _SupplierBillSToFRS.Select_VATRateType(data[10]);
...
//     _nBANKTRN.Enter_spnt_amt(data[16]);
 ...
 pages.Reconcilation _Reconcilation = new pages.Reconcilation(driver);
  ...
  pages.AmountDue_Advance_Reconsilation.PartialReconcilationLAtestForSupplierBill _Reconsilecount = new pages.AmountDue_Advance_Reconsilation.PartialReconcilationLAtestForSupplierBill(driver);
