...
public class Transaction_Search extends TestBase
{
...
pages.bankmenu _bankmenu = new pages.bankmenu(driver);
  ...
  pages.new_bank_trans.src_Trans_num _trs=new   pages.new_bank_trans.src_Trans_num(driver);
  _trs.Select_Search_category("Transaction No");
  _trs.Enter_Enter_code("");
  _trs.Click_Update_btn();
