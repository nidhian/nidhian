...
public class Ds_rpt_director extends TestBase
{
    ...
    public void GoToUrlClickReportsmenu2ClickLedgerrptPositiveSelectActtype2exClickAllPositiveSelectDaterangeL() throws InvalidFormatException, InterruptedException, IOException
    {
    	sTestCaseID="Report_Directors";
       	Sheet="UX1804";
...
//    _Searchclient.AssertUrl();
    ...
    pages.UX1804.addashboard_Report_director _dr = new  pages.UX1804.addashboard_Report_director (driver);
...
//   	
   ...
   _dr.Click_Reports_dash();
   
   TestModellerLogger.SetLastNodeGuid("0b5e9013-d457-4096-ba0b-ed57fa1a0516");
   _dr.Select_reports_dash(data[5]);
   
    	
        pages.UX1804.Rpt_Director_Bal _ldgrbook = new pages.UX1804.Rpt_Director_Bal(driver);
