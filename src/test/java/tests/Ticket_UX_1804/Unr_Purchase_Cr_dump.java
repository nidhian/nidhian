...
import pages.UX1804.Un_RecPurchase_creditor_dump;
...
public class Unr_Purchase_Cr_dump extends TestBase
{
...
//    _addashboard.AssertUrl();
    ...
    pages.UX1804.Un_RecPurchase_creditor_dump  _dump = new  Un_RecPurchase_creditor_dump(driver);
