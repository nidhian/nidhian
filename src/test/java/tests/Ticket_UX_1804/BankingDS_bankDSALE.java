...
public class BankingDS_bankDSALE extends TestBase
{
...
//    _Searchclient.AssertUrl();
    ...
    pages.UX1804.addashboard_5 _addashboard = new  pages.UX1804.addashboard_5(driver);
...
//    _addashboard.GoToUrl();
   ...
   _addashboard.Select_ctl00ddlFinancialYear(data[14]);

    

    TestModellerLogger.SetLastNodeGuid("e25c38ee-e9be-4654-bb3a-36e82a04bba1");
    _addashboard.Click_Sales_dash();
    	
        pages.UX1804.TY _TY = new pages.UX1804.TY (driver);
