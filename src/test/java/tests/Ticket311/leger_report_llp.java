...
public class leger_report_llp extends TestBase
{
...
pages.Searchclient _Searchclient = new pages.Searchclient(driver);
    ...
    _Searchclient.Enter_ctl00ctl00ParentContentcPHFiltertxtSearchCompany("LLP-BUSS2");
    ...
    pages.SM311.Ledgerbook_LLP _ldgr1=new pages.SM311.Ledgerbook_LLP (driver);
    _ldgr1.Click_AdvisorTool_Toplft1();
    _ldgr1.Click_Reports_menu_inadvisorytool1();
    _ldgr1.Click_GnralLdgerNominal_Ldgr_Rprtclicked1();
    _ldgr1.Select_selectAccountType1();
    _ldgr1.matchFromExcel1();
