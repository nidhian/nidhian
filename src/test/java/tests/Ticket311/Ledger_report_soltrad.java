...
public class Ledger_report_soltrad extends TestBase
{
...
pages.Searchclient _Searchclient = new pages.Searchclient(driver);
    ...
    pages.SM311.Ledgerbook_Soltrad  _ldgr3=new pages.SM311.Ledgerbook_Soltrad  (driver);
    _ldgr3.Click_AdvisorTool_Toplft2();
    _ldgr3.Click_Reports_menu_inadvisorytool2();
    _ldgr3.Click_GnralLdgerNominal_Ldgr_Rprtclicked2();
    _ldgr3.Select_selectAccountType2();
    _ldgr3.matchFromExcel2();
