...
public class nominalcode_Soletrander extends TestBase
{
...
pages.SM311.nominalcode_SolTrade _nominal2=new pages.SM311.nominalcode_SolTrade(driver);
...
/* public void GoToUrlAssertUrlClickAdvisorToolsToplftClickNominalCodlinkPositiveEnterSearchCodeinputPositive300() throws InvalidFormatException, InterruptedException, IOException
 {
	 sTestCaseID="TC4";
	   	Sheet="sm-311_nominalcode";
	    data = ExcelData.toReadExcelData(sTestCaseID, Sheet);
...
/*public void GoToUrlAssertUrlClickAdvisorToolsToplftClickNominalCodlinkPositiveEnterSearchCodeinputPositive322() throws InvalidFormatException, InterruptedException, IOException
{
		sTestCaseID="TC5";
	Sheet="sm-311_nominalcode";
 data = ExcelData.toReadExcelData(sTestCaseID, Sheet);
