...
public class ledger_report_Partnership extends TestBase
{
...
//        _AgentSearch.AssertUrl();
    ...
    pages.Searchclient _Searchclient = new pages.Searchclient(driver);
        ...
        pages.SM311.Ledgerbook _ldgr=new  pages.SM311.Ledgerbook (driver);
        _ldgr.Click_AdvisorTool_Toplft();
        _ldgr.Click_Reports_menu_inadvisorytool();
        _ldgr.Click_GnralLdgerNominal_Ldgr_Rprtclicked();
        _ldgr.Select_selectAccountType();
        _ldgr.matchFromExcel();
 ...
 /*public void GoToUrlAssertUrlClickAdvisorToolsToplftClickNominalCodlinkPositiveEnterSearchCodeinputPositive2() throws InvalidFormatException, InterruptedException, IOException
 {
    ...
    pages.AgentSearch _AgentSearch = new pages.AgentSearch(driver);
        ...
        TestModellerLogger.SetLastNodeGuid("9afd81f0-5ffc-4b6b-9602-9604f0d3d258");
        _AgentSearch.Enter_ctl00cPHFiltertxtAgentName("LLP_AGENT");
    ...
    pages.Searchclient _Searchclient = new pages.Searchclient(driver);
        ...
        TestModellerLogger.SetLastNodeGuid("a71cb6de-7787-4e86-ac83-a09ab1ce3b13");
        _Searchclient.Enter_ctl00ctl00ParentContentcPHFiltertxtSearchCompany("LLP_BUSS");
...
//   _nominal.Enter_ctl00cPHFiltertxtCode(data[5]);
//    
//
