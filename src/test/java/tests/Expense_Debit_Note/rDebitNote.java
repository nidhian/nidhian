package tests.Expense_Debit_Note;
...
import pages.Expenditure_View.SUPLISTSERACH;
import pages.Expenditure_View.expenditure_Supplierlist;
import pages.Expense_DebitNote.Expense_DebitNote;
import pages.Expense_DebitNote.Expense_Suplierdropdown;
...
public class rDebitNote extends TestBase
{
...
//    _Searchclient.AssertUrl();
    ...
    expenditure_Supplierlist _DebitNoteSToFRS = new expenditure_Supplierlist (driver);
...
_DebitNoteSToFRS.Click_View_Menu();


TestModellerLogger.SetLastNodeGuid("e0eca6d7-6b04-416d-855d-2a9e825dcd28");
_DebitNoteSToFRS.Click_Supplier_List();

SUPLISTSERACH _Supplierlist = new SUPLISTSERACH (driver);


TestModellerLogger.SetLastNodeGuid("190c6323-be0b-4dd1-b552-dbe6423a4af8");
_Supplierlist.Click_Sup_Search__btn();
...
Expense_Suplierdropdown _DebitNoteSToFRS = new Expense_Suplierdropdown(driver);
//TestModellerLogger.SetLastNodeGuid("a9ac356a-1ff8-48d1-98c6-5613b1e1ba5a");
//_DebitNoteSToFRS.GoToUrl();
//
//
...
TestModellerLogger.SetLastNodeGuid("13d7978e-e074-45d2-8c0b-01b123aa6311");
_DebitNoteSToFRS.Select_SupplierName();
