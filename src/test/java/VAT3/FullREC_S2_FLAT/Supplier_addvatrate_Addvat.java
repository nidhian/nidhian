...
public class Supplier_addvatrate_Addvat extends TestBase
{
    ...
    public void GoToUrlAssertUrlPositiveSelectVATStatus1PositiveEnterEffectiveDatePositiveSelectFlatrateBusines() throws InterruptedException, InvalidFormatException, IOException
    {
    	
    	sTestCaseID="FULL_Rec_S2F_Addvat1";
       	Sheet="VAT3";
...
//    _addVatrate.AssertUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("b81fccd4-7cd8-416f-868f-575a580512c7");
    _addVatrate.Enter_OverrideFLATRate("15");
