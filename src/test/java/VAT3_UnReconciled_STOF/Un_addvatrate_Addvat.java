...
public class Un_addvatrate_Addvat extends TestBase
{
...
//  _EditSettingToStandard.Click_VATTypeEdit();
        ...
        pages.FRSTOStandard _addVatrate = new pages.FRSTOStandard(driver);
...
//    _addVatrate.AssertUrl();
        ...
        _addVatrate.Click_AddButton();

    TestModellerLogger.SetLastNodeGuid("6e060c6a-4d91-4fcb-83c9-1b01a39e2e6c");
    _addVatrate.Select_VATStatus(data[5]);
    
  

    TestModellerLogger.SetLastNodeGuid("b81fccd4-7cd8-416f-868f-575a580512c7");
    _addVatrate.Enter_Date(data[6]);
    
//    
//    TestModellerLogger.SetLastNodeGuid("6e060c6a-4d91-4fcb-83c9-1b01a39e2e6c");
//    _addVatrate.
//    TestModellerLogger.SetLastNodeGuid("6e060c6a-4d91-4fcb-83c9-1b01a39e2e6c");
//    _addVatrate.Click_Flat_Rate_chkbox();
    
    
    
//    TestModellerLogger.SetLastNodeGuid("6e060c6a-4d91-4fcb-83c9-1b01a39e2e6c");
//    _addVatrate.Enter_OverrideFLATRate(data[7]);
